    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method = "post" action="">
            <div class="mb-3">
              <label for="player_id" class="form-label">Player's Name</label>
              <input type="text" class="form-control" id="player_id" name = "player_id">
      </div>
            <div class="mb-3">
              <label for="player_age" class="form-label">Player's Age</label>
              <input type="text" class="form-control" id="player_age" name = "player_age">
            </div>
