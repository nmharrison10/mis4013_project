 ...
 switch ($_POST['actionType']){
  case 'Add':
   if (insertPlayers($_POST['pName'],$_POST['pNumber'],$_POST['pAge'],$_POST['cid'],$_POST['countryid'])){
    echo '<div style="margin:15px" class="alert alert-success" role="alert">Player Added!</div>';
   } else {
  ...
  case 'Edit':
   if (updatePlayers($_POST['pName'],$_POST['pNumber'],$_POST['pAge'],$_POST['cid'],$_POST['countryid'],$_POST['pid'] )){
    echo '<div style="margin:15px" class="alert alert-success" role="alert">Player Updated!</div>';
   } else {
    echo '<div style="margin:15px" class="alert alert-danger" role="alert">Error</div>';
   }
   break;
  case 'Delete':
   if (deletePlayers($_POST['pid'])){
    echo '<div style="margin:15px" class="alert alert-success" role="alert"> Player Deleted!</div>';
   } else {
    echo '<div style="margin:15px" class="alert alert-danger" role="alert">Error</div>';
   }
   break;
