...
function selectPlayers() {
    try {
        ...
        $stmt = $conn->prepare("SELECT p.player_id, p.player_name, p.player_number, p.player_age, p.club_id, c.club_id, c.club_name, country.country_name FROM `player` p JOIN club c ON p.club_id = c.club_id
